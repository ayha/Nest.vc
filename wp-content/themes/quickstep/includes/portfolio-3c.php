<div class="row">
    ...
    <section class="twelve columns">
        ...
        <ul id="filter" class="filter clearfix" data-option-key="filter">
            <p style="text-align: center;"><img class="size-full wp-image-97 aligncenter" style="padding-top:10px" alt="title-portfolio" src="http://nest.vc/wp-content/uploads/2013/11/title-portfolio.jpg" width="960" height="19" /></p>
		<li style="display:none" ><a href="#" class="all" data-filter="*" ><?php _e('All', 'qs_framework'); ?></a></li>
